...
const EditMember = ({ member, onEdit }) => {
  ...
  useEffect(() => {
    ...
    // You might want to handle image in a different way, like using the existing image URL if available.
  }, [member]);
  ...
  const onSubmit = (e) => {
    ...
    onEdit(member.id, updatedMember); // Call the onEdit function with member ID and updated data
  };
  return (
